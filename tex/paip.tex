% -*- noweb-code-mode: lisp-mode; -*-% ===> this file was generated automatically by noweave --- better not edit it
...
;; Exercise 1.4
\LA{}Exercise 1.4~{\nwtagstyle{}\subpageref{NWlJ9ZL-19iRAp-1}}\RA{}

;; Exercise 1.5
\LA{}Exercise 1.5~{\nwtagstyle{}\subpageref{NWlJ9ZL-3hXPUh-1}}\RA{}
...
(define-test test-last-name
  ...
  \LA{}Morton Downey, Jr.~{\nwtagstyle{}\subpageref{NWlJ9ZL-12cyya-1}}\RA{})
\nwused{\\{NWlJ9ZL-4Wuo2N-1}}\nwendcode{}\nwbegindocs{29}\nwdocspar
...
\nwenddocs{}\nwbegincode{32}\sublabel{NWlJ9ZL-12cyya-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-12cyya-1}}}\moddef{Morton Downey, Jr.~{\nwtagstyle{}\subpageref{NWlJ9ZL-12cyya-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-29KvuZ-1}}\nwenddeflinemarkup
(assert-equal 'Downey (\nwlinkedidentc{last-name}{NWlJ9ZL-4Zlwoj-1} '(Morton Downey Jr.)))
\nwused{\\{NWlJ9ZL-29KvuZ-1}}\nwidentuses{\\{{\nwixident{last-name}}{last-name}}}\nwindexuse{\nwixident{last-name}}{last-name}{NWlJ9ZL-12cyya-1}\nwendcode{}\nwbegindocs{33}\nwdocspar
...
(defun \nwlinkedidentc{count-atoms}{NWlJ9ZL-2b8599-1} (exp &optional (if-null 1))\nwindexdefn{\nwixident{count-atoms}}{count-atoms}{NWlJ9ZL-2b8599-1}
  "Return the total number of atoms in the expression,
   counting nil as an atom only in non-tail position."
  (cond \LA{}if exp is nil there are if-null atoms~{\nwtagstyle{}\subpageref{NWlJ9ZL-3CRXLe-1}}\RA{}
...
\nwenddocs{}\nwbegincode{50}\sublabel{NWlJ9ZL-3CRXLe-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3CRXLe-1}}}\moddef{if exp is nil there are if-null atoms~{\nwtagstyle{}\subpageref{NWlJ9ZL-3CRXLe-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-2b8599-1}}\nwenddeflinemarkup
((null exp) if-null)
...
(t (+ (\nwlinkedidentc{count-atoms}{NWlJ9ZL-2b8599-1} (first exp) 1)
      (\nwlinkedidentc{count-atoms}{NWlJ9ZL-2b8599-1} (rest exp) 0)))
\nwused{\\{NWlJ9ZL-2b8599-1}}\nwidentuses{\\{{\nwixident{count-atoms}}{count-atoms}}}\nwindexuse{\nwixident{count-atoms}}{count-atoms}{NWlJ9ZL-44AOMF-1}\nwendcode{}\nwbegindocs{55}\nwdocspar

\subsection{Exercise 1.4}

\nwenddocs{}\nwbegincode{56}\sublabel{NWlJ9ZL-19iRAp-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-19iRAp-1}}}\moddef{Exercise 1.4~{\nwtagstyle{}\subpageref{NWlJ9ZL-19iRAp-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3M2WD4-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{count-anywhere}{NWlJ9ZL-19iRAp-1} (item tree)\nwindexdefn{\nwixident{count-anywhere}}{count-anywhere}{NWlJ9ZL-19iRAp-1}
  "Count the occurrences of item anywhere within tree."
  (cond \LA{}if item is equal to tree, there is one occurrence~{\nwtagstyle{}\subpageref{NWlJ9ZL-1L8ovk-1}}\RA{}
        \LA{}if tree is an atom, there are no occurrences~{\nwtagstyle{}\subpageref{NWlJ9ZL-4atmh5-1}}\RA{}
        \LA{}otherwise, add the occurrence within first the first and rest of tree~{\nwtagstyle{}\subpageref{NWlJ9ZL-4TNpRz-1}}\RA{}))

\LA{}Exercise 1.4 tests~{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdKag-1}}\RA{}
\nwused{\\{NWlJ9ZL-3M2WD4-1}}\nwidentdefs{\\{{\nwixident{count-anywhere}}{count-anywhere}}}\nwendcode{}\nwbegindocs{57}\nwdocspar

\nwenddocs{}\nwbegincode{58}\sublabel{NWlJ9ZL-1L8ovk-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-1L8ovk-1}}}\moddef{if item is equal to tree, there is one occurrence~{\nwtagstyle{}\subpageref{NWlJ9ZL-1L8ovk-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-19iRAp-1}}\nwenddeflinemarkup
((eql item tree) 1)
\nwused{\\{NWlJ9ZL-19iRAp-1}}\nwendcode{}\nwbegindocs{59}\nwdocspar

\nwenddocs{}\nwbegincode{60}\sublabel{NWlJ9ZL-4atmh5-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-4atmh5-1}}}\moddef{if tree is an atom, there are no occurrences~{\nwtagstyle{}\subpageref{NWlJ9ZL-4atmh5-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-19iRAp-1}}\nwenddeflinemarkup
((atom tree) 0)
\nwused{\\{NWlJ9ZL-19iRAp-1}}\nwendcode{}\nwbegindocs{61}\nwdocspar

\nwenddocs{}\nwbegincode{62}\sublabel{NWlJ9ZL-4TNpRz-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-4TNpRz-1}}}\moddef{otherwise, add the occurrence within first the first and rest of tree~{\nwtagstyle{}\subpageref{NWlJ9ZL-4TNpRz-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-19iRAp-1}}\nwenddeflinemarkup
(t (+ (\nwlinkedidentc{count-anywhere}{NWlJ9ZL-19iRAp-1} item (first tree))
      (\nwlinkedidentc{count-anywhere}{NWlJ9ZL-19iRAp-1} item (rest tree))))
\nwused{\\{NWlJ9ZL-19iRAp-1}}\nwidentuses{\\{{\nwixident{count-anywhere}}{count-anywhere}}}\nwindexuse{\nwixident{count-anywhere}}{count-anywhere}{NWlJ9ZL-4TNpRz-1}\nwendcode{}\nwbegindocs{63}\nwdocspar

\nwenddocs{}\nwbegincode{64}\sublabel{NWlJ9ZL-1GdKag-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdKag-1}}}\moddef{Exercise 1.4 tests~{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdKag-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-19iRAp-1}}\nwenddeflinemarkup
(define-test test-count-anywhere
  (assert-equal 3 (\nwlinkedidentc{count-anywhere}{NWlJ9ZL-19iRAp-1} 'a '(a ((a) b) a))))
\nwused{\\{NWlJ9ZL-19iRAp-1}}\nwidentuses{\\{{\nwixident{count-anywhere}}{count-anywhere}}}\nwindexuse{\nwixident{count-anywhere}}{count-anywhere}{NWlJ9ZL-1GdKag-1}\nwendcode{}\nwbegindocs{65}\nwdocspar

\subsection{Exercise 1.5}

\nwenddocs{}\nwbegincode{66}\sublabel{NWlJ9ZL-3hXPUh-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3hXPUh-1}}}\moddef{Exercise 1.5~{\nwtagstyle{}\subpageref{NWlJ9ZL-3hXPUh-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3M2WD4-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{dot-product}{NWlJ9ZL-3hXPUh-1} (lhs rhs)\nwindexdefn{\nwixident{dot-product}}{dot-product}{NWlJ9ZL-3hXPUh-1}
  "Compute the mathematical dot product of two vectors."
  \LA{}multiply elements of the vectors pairwise and sum the results~{\nwtagstyle{}\subpageref{NWlJ9ZL-jnnLg-1}}\RA{})

\LA{}Exercise 1.5 tests~{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdGQe-1}}\RA{}
\nwused{\\{NWlJ9ZL-3M2WD4-1}}\nwidentdefs{\\{{\nwixident{dot-product}}{dot-product}}}\nwendcode{}\nwbegindocs{67}\nwdocspar

\href{http://www.lispworks.com/documentation/HyperSpec/Body/f_mapc_.htm\#mapcar}
\nwenddocs{}\nwbegincode{68}\sublabel{NWlJ9ZL-jnnLg-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-jnnLg-1}}}\moddef{multiply elements of the vectors pairwise and sum the results~{\nwtagstyle{}\subpageref{NWlJ9ZL-jnnLg-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3hXPUh-1}}\nwenddeflinemarkup
(apply #'+ (mapcar #'* lhs rhs))
\nwused{\\{NWlJ9ZL-3hXPUh-1}}\nwendcode{}\nwbegindocs{69}\nwdocspar

\nwenddocs{}\nwbegincode{70}\sublabel{NWlJ9ZL-1GdGQe-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdGQe-1}}}\moddef{Exercise 1.5 tests~{\nwtagstyle{}\subpageref{NWlJ9ZL-1GdGQe-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3hXPUh-1}}\nwenddeflinemarkup
(define-test test-dot-product
  (assert-equal 110 (\nwlinkedidentc{dot-product}{NWlJ9ZL-3hXPUh-1} '(10 20) '(3 4))))
\nwused{\\{NWlJ9ZL-3hXPUh-1}}\nwidentuses{\\{{\nwixident{dot-product}}{dot-product}}}\nwindexuse{\nwixident{dot-product}}{dot-product}{NWlJ9ZL-1GdGQe-1}\nwendcode{}\nwbegindocs{71}\nwdocspar

\section{Higher-Order Functions}

\nwenddocs{}\nwbegincode{72}\sublabel{NWlJ9ZL-4BOcTg-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-4BOcTg-1}}}\moddef{mappend~{\nwtagstyle{}\subpageref{NWlJ9ZL-4BOcTg-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-2}\\{NWlJ9ZL-wDl5T-1}\\{NWlJ9ZL-4MxtLd-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{mappend}{NWlJ9ZL-4BOcTg-1} (fn the-list)\nwindexdefn{\nwixident{mappend}}{mappend}{NWlJ9ZL-4BOcTg-1}
  "Apply fn to each element of list and append the results."
  (apply #'append (mapcar fn the-list)))
\nwused{\\{NWlJ9ZL-10eMDV-2}\\{NWlJ9ZL-wDl5T-1}\\{NWlJ9ZL-4MxtLd-1}}\nwidentdefs{\\{{\nwixident{mappend}}{mappend}}}\nwendcode{}\nwbegindocs{73}\nwdocspar

\chapter{A Simple Lisp Program}

\nwenddocs{}\nwbegincode{74}\sublabel{NWlJ9ZL-10eMDV-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\endmoddef\nwstartdeflinemarkup\nwprevnextdefs{\relax}{NWlJ9ZL-10eMDV-2}\nwenddeflinemarkup
(in-package #:paip)
(defpackage #:paip.simple
  (:\nwlinkedidentc{use}{NWlJ9ZL-3V5be-1} #:cl #:lisp-unit))
(in-package #:paip.simple)
\nwalsodefined{\\{NWlJ9ZL-10eMDV-2}\\{NWlJ9ZL-10eMDV-3}\\{NWlJ9ZL-10eMDV-4}\\{NWlJ9ZL-10eMDV-5}\\{NWlJ9ZL-10eMDV-6}\\{NWlJ9ZL-10eMDV-7}\\{NWlJ9ZL-10eMDV-8}\\{NWlJ9ZL-10eMDV-9}\\{NWlJ9ZL-10eMDV-A}\\{NWlJ9ZL-10eMDV-B}\\{NWlJ9ZL-10eMDV-C}}\nwnotused{src/simple.lisp}\nwidentuses{\\{{\nwixident{use}}{use}}}\nwindexuse{\nwixident{use}}{use}{NWlJ9ZL-10eMDV-1}\nwendcode{}\nwbegindocs{75}\nwdocspar

\setcounter{section}{1}
\section{A Straightforward Solution}

\nwenddocs{}\nwbegincode{76}\sublabel{NWlJ9ZL-10eMDV-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-2}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-1}{NWlJ9ZL-10eMDV-3}\nwenddeflinemarkup
(defun \nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} ()\nwindexdefn{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-2}
  (append (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3}) (\nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2})))

(defun \nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2} ()\nwindexdefn{\nwixident{verb-phrase}}{verb-phrase}{NWlJ9ZL-10eMDV-2}
  (append (\nwlinkedidentc{Verb}{NWlJ9ZL-10eMDV-2}) (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3})))

(defun \nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2} ()\nwindexdefn{\nwixident{Article}}{Article}{NWlJ9ZL-10eMDV-2}
  (\nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} '(the a)))

(defun \nwlinkedidentc{Noun}{NWlJ9ZL-10eMDV-2} ()\nwindexdefn{\nwixident{Noun}}{Noun}{NWlJ9ZL-10eMDV-2}
  (\nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} '(man ball woman table)))

(defun \nwlinkedidentc{Verb}{NWlJ9ZL-10eMDV-2} ()\nwindexdefn{\nwixident{Verb}}{Verb}{NWlJ9ZL-10eMDV-2}
  (\nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} '(hit took saw liked)))

\LA{}one-of~{\nwtagstyle{}\subpageref{NWlJ9ZL-3GVt2q-1}}\RA{}

\LA{}random-elt~{\nwtagstyle{}\subpageref{NWlJ9ZL-2bmzlG-1}}\RA{}

\LA{}mappend~{\nwtagstyle{}\subpageref{NWlJ9ZL-4BOcTg-1}}\RA{}
\nwidentdefs{\\{{\nwixident{Article}}{Article}}\\{{\nwixident{Noun}}{Noun}}\\{{\nwixident{sentence}}{sentence}}\\{{\nwixident{Verb}}{Verb}}\\{{\nwixident{verb-phrase}}{verb-phrase}}}\nwidentuses{\\{{\nwixident{noun-phrase}}{noun-phrase}}\\{{\nwixident{one-of}}{one-of}}}\nwindexuse{\nwixident{noun-phrase}}{noun-phrase}{NWlJ9ZL-10eMDV-2}\nwindexuse{\nwixident{one-of}}{one-of}{NWlJ9ZL-10eMDV-2}\nwendcode{}\nwbegindocs{77}\nwdocspar

\nwenddocs{}\nwbegincode{78}\sublabel{NWlJ9ZL-3GVt2q-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3GVt2q-1}}}\moddef{one-of~{\nwtagstyle{}\subpageref{NWlJ9ZL-3GVt2q-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-2}}\nwenddeflinemarkup
(defun \nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} (set)\nwindexdefn{\nwixident{one-of}}{one-of}{NWlJ9ZL-3GVt2q-1}
  "Pick one element of set, and make a list of it."
  (list (\nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} set)))
\nwused{\\{NWlJ9ZL-10eMDV-2}}\nwidentdefs{\\{{\nwixident{one-of}}{one-of}}}\nwidentuses{\\{{\nwixident{random-elt}}{random-elt}}}\nwindexuse{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-3GVt2q-1}\nwendcode{}\nwbegindocs{79}\nwdocspar

\nwenddocs{}\nwbegincode{80}\sublabel{NWlJ9ZL-2bmzlG-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-2bmzlG-1}}}\moddef{random-elt~{\nwtagstyle{}\subpageref{NWlJ9ZL-2bmzlG-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-2}\\{NWlJ9ZL-4MxtLd-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} (choices)\nwindexdefn{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-2bmzlG-1}
  "Choose an element from a list at random."
  (elt choices (random (length choices))))
\nwused{\\{NWlJ9ZL-10eMDV-2}\\{NWlJ9ZL-4MxtLd-1}}\nwidentdefs{\\{{\nwixident{random-elt}}{random-elt}}}\nwendcode{}\nwbegindocs{81}\nwdocspar

\nwenddocs{}\nwbegincode{82}\sublabel{NWlJ9ZL-10eMDV-3}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-3}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-2}{NWlJ9ZL-10eMDV-4}\nwenddeflinemarkup
(defun \nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{Adj*}}{Adj*}{NWlJ9ZL-10eMDV-3}
  (if (= (random 2) 0)
      nil
    (append (\nwlinkedidentc{Adj}{NWlJ9ZL-10eMDV-3}) (\nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3}))))

(defun \nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{PP*}}{PP*}{NWlJ9ZL-10eMDV-3}
  (if (\nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} '(t nil))
      (append (\nwlinkedidentc{PP}{NWlJ9ZL-10eMDV-3}) (\nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3}))
    nil))

(defun \nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{noun-phrase}}{noun-phrase}{NWlJ9ZL-10eMDV-3}
  (append (\nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2}) (\nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3}) (\nwlinkedidentc{Noun}{NWlJ9ZL-10eMDV-2}) (\nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3})))

(defun \nwlinkedidentc{PP}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{PP}}{PP}{NWlJ9ZL-10eMDV-3}
  (append (\nwlinkedidentc{Prep}{NWlJ9ZL-10eMDV-3}) (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3})))

(defun \nwlinkedidentc{Adj}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{Adj}}{Adj}{NWlJ9ZL-10eMDV-3}
  (\nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} '(big little blue green adiabatic)))

(defun \nwlinkedidentc{Prep}{NWlJ9ZL-10eMDV-3} ()\nwindexdefn{\nwixident{Prep}}{Prep}{NWlJ9ZL-10eMDV-3}
  (\nwlinkedidentc{one-of}{NWlJ9ZL-3GVt2q-1} '(to in by with on)))
\nwidentdefs{\\{{\nwixident{Adj}}{Adj}}\\{{\nwixident{Adj*}}{Adj*}}\\{{\nwixident{noun-phrase}}{noun-phrase}}\\{{\nwixident{PP}}{PP}}\\{{\nwixident{PP*}}{PP*}}\\{{\nwixident{Prep}}{Prep}}}\nwidentuses{\\{{\nwixident{Article}}{Article}}\\{{\nwixident{Noun}}{Noun}}\\{{\nwixident{one-of}}{one-of}}\\{{\nwixident{random-elt}}{random-elt}}}\nwindexuse{\nwixident{Article}}{Article}{NWlJ9ZL-10eMDV-3}\nwindexuse{\nwixident{Noun}}{Noun}{NWlJ9ZL-10eMDV-3}\nwindexuse{\nwixident{one-of}}{one-of}{NWlJ9ZL-10eMDV-3}\nwindexuse{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-10eMDV-3}\nwendcode{}\nwbegindocs{83}\nwdocspar

\section{A Rule-Based Solution}

\nwenddocs{}\nwbegincode{84}\sublabel{NWlJ9ZL-10eMDV-4}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-4}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-3}{NWlJ9ZL-10eMDV-5}\nwenddeflinemarkup
(defparameter *simple-grammar*
  '((\nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} -> (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2}))
    (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} -> (\nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2} \nwlinkedidentc{Noun}{NWlJ9ZL-10eMDV-2}))
    (\nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2} -> (\nwlinkedidentc{Verb}{NWlJ9ZL-10eMDV-2} \nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3}))
    (\nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2} -> the a)
    (\nwlinkedidentc{Noun}{NWlJ9ZL-10eMDV-2} -> man ball woman table)
    (\nwlinkedidentc{Verb}{NWlJ9ZL-10eMDV-2} -> hit took saw liked))
  "A grammar for a trivial subset of English.")

(defvar \nwlinkedidentc{*grammar*}{NWlJ9ZL-10eMDV-4} *simple-grammar*\nwindexdefn{\nwixident{*grammar*}}{*grammar*}{NWlJ9ZL-10eMDV-4}
  "The grammar used by generate. Initially, this is *simple-grammar*,
   but we can switch to other grammars.")
\nwidentdefs{\\{{\nwixident{*grammar*}}{*grammar*}}}\nwidentuses{\\{{\nwixident{Article}}{Article}}\\{{\nwixident{Noun}}{Noun}}\\{{\nwixident{noun-phrase}}{noun-phrase}}\\{{\nwixident{sentence}}{sentence}}\\{{\nwixident{Verb}}{Verb}}\\{{\nwixident{verb-phrase}}{verb-phrase}}}\nwindexuse{\nwixident{Article}}{Article}{NWlJ9ZL-10eMDV-4}\nwindexuse{\nwixident{Noun}}{Noun}{NWlJ9ZL-10eMDV-4}\nwindexuse{\nwixident{noun-phrase}}{noun-phrase}{NWlJ9ZL-10eMDV-4}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-4}\nwindexuse{\nwixident{Verb}}{Verb}{NWlJ9ZL-10eMDV-4}\nwindexuse{\nwixident{verb-phrase}}{verb-phrase}{NWlJ9ZL-10eMDV-4}\nwendcode{}\nwbegindocs{85}\nwdocspar

\nwenddocs{}\nwbegincode{86}\sublabel{NWlJ9ZL-10eMDV-5}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-5}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-4}{NWlJ9ZL-10eMDV-6}\nwenddeflinemarkup
(defun \nwlinkedidentc{rule-lhs}{NWlJ9ZL-10eMDV-5} (rule)\nwindexdefn{\nwixident{rule-lhs}}{rule-lhs}{NWlJ9ZL-10eMDV-5}
  "The left-hand side of a rule."
  (first rule))

(defun \nwlinkedidentc{rule-rhs}{NWlJ9ZL-10eMDV-5} (rule)\nwindexdefn{\nwixident{rule-rhs}}{rule-rhs}{NWlJ9ZL-10eMDV-5}
  "The right-hand side of a rule."
  (rest (rest rule)))

(defun \nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} (category)\nwindexdefn{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-10eMDV-5}
  "Return a list of the possible \nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} for this category."
  (\nwlinkedidentc{rule-rhs}{NWlJ9ZL-10eMDV-5} (assoc category \nwlinkedidentc{*grammar*}{NWlJ9ZL-10eMDV-4})))
\nwidentdefs{\\{{\nwixident{rewrites}}{rewrites}}\\{{\nwixident{rule-lhs}}{rule-lhs}}\\{{\nwixident{rule-rhs}}{rule-rhs}}}\nwidentuses{\\{{\nwixident{*grammar*}}{*grammar*}}}\nwindexuse{\nwixident{*grammar*}}{*grammar*}{NWlJ9ZL-10eMDV-5}\nwendcode{}\nwbegindocs{87}\nwdocspar
...
\nwenddocs{}\nwbegincode{88}\sublabel{NWlJ9ZL-33cvLf-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-33cvLf-1}}}\moddef{if-let~{\nwtagstyle{}\subpageref{NWlJ9ZL-33cvLf-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-6}}\nwenddeflinemarkup
(defmacro \nwlinkedidentc{if-let}{NWlJ9ZL-33cvLf-1} ((name test) then &optional else)\nwindexdefn{\nwixident{if-let}}{if-let}{NWlJ9ZL-33cvLf-1}
  `(let ((,name ,test))
     (if ,name ,then ,else)))
\nwused{\\{NWlJ9ZL-10eMDV-6}}\nwidentdefs{\\{{\nwixident{if-let}}{if-let}}}\nwendcode{}\nwbegindocs{89}\nwdocspar

\begin{marginnote}
\nwenddocs{}\nwbegincode{90}\sublabel{NWlJ9ZL-2FJjMW-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}}\moddef{phrase is a list~{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-6}\\{NWlJ9ZL-10eMDV-7}\\{NWlJ9ZL-10eMDV-9}\\{NWlJ9ZL-10eMDV-A}}\nwenddeflinemarkup
(listp phrase)
\nwused{\\{NWlJ9ZL-10eMDV-6}\\{NWlJ9ZL-10eMDV-7}\\{NWlJ9ZL-10eMDV-9}\\{NWlJ9ZL-10eMDV-A}}\nwendcode{}\nwbegindocs{91}\nwdocspar

\nwenddocs{}\nwbegincode{92}\sublabel{NWlJ9ZL-288w6M-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-288w6M-1}}}\moddef{generate a phrase~{\nwtagstyle{}\subpageref{NWlJ9ZL-288w6M-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-6}\\{NWlJ9ZL-10eMDV-7}}\nwenddeflinemarkup
(\nwlinkedidentc{mappend}{NWlJ9ZL-4BOcTg-1} #'\nwlinkedidentc{generate}{NWlJ9ZL-10eMDV-6} phrase)
\nwused{\\{NWlJ9ZL-10eMDV-6}\\{NWlJ9ZL-10eMDV-7}}\nwidentuses{\\{{\nwixident{generate}}{generate}}\\{{\nwixident{mappend}}{mappend}}}\nwindexuse{\nwixident{generate}}{generate}{NWlJ9ZL-288w6M-1}\nwindexuse{\nwixident{mappend}}{mappend}{NWlJ9ZL-288w6M-1}\nwendcode{}\nwbegindocs{93}\nwdocspar
\end{marginnote}

\nwenddocs{}\nwbegincode{94}\sublabel{NWlJ9ZL-10eMDV-6}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-6}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-5}{NWlJ9ZL-10eMDV-7}\nwenddeflinemarkup
\LA{}if-let~{\nwtagstyle{}\subpageref{NWlJ9ZL-33cvLf-1}}\RA{}

(defun \nwlinkedidentc{generate}{NWlJ9ZL-10eMDV-6} (phrase)\nwindexdefn{\nwixident{generate}}{generate}{NWlJ9ZL-10eMDV-6}
  "Generate a random \nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} or phrase."
  (if \LA{}phrase is a list~{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}\RA{}
      \LA{}generate a phrase~{\nwtagstyle{}\subpageref{NWlJ9ZL-288w6M-1}}\RA{}
    (\nwlinkedidentc{if-let}{NWlJ9ZL-33cvLf-1} (choices (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} phrase))
        (\nwlinkedidentc{generate}{NWlJ9ZL-10eMDV-6} (\nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} choices))
      (list phrase))))
\nwidentdefs{\\{{\nwixident{generate}}{generate}}}\nwidentuses{\\{{\nwixident{if-let}}{if-let}}\\{{\nwixident{random-elt}}{random-elt}}\\{{\nwixident{rewrites}}{rewrites}}\\{{\nwixident{sentence}}{sentence}}}\nwindexuse{\nwixident{if-let}}{if-let}{NWlJ9ZL-10eMDV-6}\nwindexuse{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-10eMDV-6}\nwindexuse{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-10eMDV-6}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-6}\nwendcode{}\nwbegindocs{95}\nwdocspar


\subsection{Exercise 2.2}

\begin{marginnote}
\nwenddocs{}\nwbegincode{96}\sublabel{NWlJ9ZL-2uqsv4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-2uqsv4-1}}}\moddef{phrase is nonterminal~{\nwtagstyle{}\subpageref{NWlJ9ZL-2uqsv4-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-7}}\nwenddeflinemarkup
(\nwlinkedidentc{non-terminal-p}{NWlJ9ZL-WAQYi-1} phrase)
\nwused{\\{NWlJ9ZL-10eMDV-7}}\nwidentuses{\\{{\nwixident{non-terminal-p}}{non-terminal-p}}}\nwindexuse{\nwixident{non-terminal-p}}{non-terminal-p}{NWlJ9ZL-2uqsv4-1}\nwendcode{}\nwbegindocs{97}\nwdocspar
\end{marginnote}

\nwenddocs{}\nwbegincode{98}\sublabel{NWlJ9ZL-WAQYi-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-WAQYi-1}}}\moddef{non-terminal-p~{\nwtagstyle{}\subpageref{NWlJ9ZL-WAQYi-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-10eMDV-7}}\nwenddeflinemarkup
(defun \nwlinkedidentc{non-terminal-p}{NWlJ9ZL-WAQYi-1} (category)\nwindexdefn{\nwixident{non-terminal-p}}{non-terminal-p}{NWlJ9ZL-WAQYi-1}
  "Return true iff this is a category in the grammar."
  (not (null (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} category))))
\nwused{\\{NWlJ9ZL-10eMDV-7}}\nwidentdefs{\\{{\nwixident{non-terminal-p}}{non-terminal-p}}}\nwidentuses{\\{{\nwixident{rewrites}}{rewrites}}}\nwindexuse{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-WAQYi-1}\nwendcode{}\nwbegindocs{99}\nwdocspar

\nwenddocs{}\nwbegincode{100}\sublabel{NWlJ9ZL-10eMDV-7}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-7}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-6}{NWlJ9ZL-10eMDV-8}\nwenddeflinemarkup
(defun \nwlinkedidentc{generate-alt}{NWlJ9ZL-10eMDV-7} (phrase)\nwindexdefn{\nwixident{generate-alt}}{generate-alt}{NWlJ9ZL-10eMDV-7}
  "Generate a random \nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} or phrase,
   differentiating between terminal and nonterminal symbols."
  (cond (\LA{}phrase is a list~{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}\RA{}
         \LA{}generate a phrase~{\nwtagstyle{}\subpageref{NWlJ9ZL-288w6M-1}}\RA{})
        (\LA{}phrase is nonterminal~{\nwtagstyle{}\subpageref{NWlJ9ZL-2uqsv4-1}}\RA{}
         (\nwlinkedidentc{generate}{NWlJ9ZL-10eMDV-6} (\nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} phrase))))
        (t (list phrase))))

\LA{}non-terminal-p~{\nwtagstyle{}\subpageref{NWlJ9ZL-WAQYi-1}}\RA{}
\nwidentdefs{\\{{\nwixident{generate-alt}}{generate-alt}}}\nwidentuses{\\{{\nwixident{generate}}{generate}}\\{{\nwixident{random-elt}}{random-elt}}\\{{\nwixident{rewrites}}{rewrites}}\\{{\nwixident{sentence}}{sentence}}}\nwindexuse{\nwixident{generate}}{generate}{NWlJ9ZL-10eMDV-7}\nwindexuse{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-10eMDV-7}\nwindexuse{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-10eMDV-7}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-7}\nwendcode{}\nwbegindocs{101}\nwdocspar

\section{Changing the Grammar without Changing the Program}

\nwenddocs{}\nwbegincode{102}\sublabel{NWlJ9ZL-10eMDV-8}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-8}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-7}{NWlJ9ZL-10eMDV-9}\nwenddeflinemarkup
(defparameter *bigger-grammar*
  '((\nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} -> (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2}))
    (\nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} -> (\nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2} \nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{Noun}{NWlJ9ZL-10eMDV-2} \nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3}) (Name) (Pronoun))
    (\nwlinkedidentc{verb-phrase}{NWlJ9ZL-10eMDV-2} -> (\nwlinkedidentc{Verb}{NWlJ9ZL-10eMDV-2} \nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3}))
    (\nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3} -> () (\nwlinkedidentc{PP}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{PP*}{NWlJ9ZL-10eMDV-3}))
    (\nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3} -> () (\nwlinkedidentc{Adj}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{Adj*}{NWlJ9ZL-10eMDV-3}))
    (\nwlinkedidentc{PP}{NWlJ9ZL-10eMDV-3} -> (\nwlinkedidentc{Prep}{NWlJ9ZL-10eMDV-3} \nwlinkedidentc{noun-phrase}{NWlJ9ZL-10eMDV-3}))
    (\nwlinkedidentc{Prep}{NWlJ9ZL-10eMDV-3} -> to in by with on)
    (\nwlinkedidentc{Adj}{NWlJ9ZL-10eMDV-3} -> big little blue green adiabatic)
    (\nwlinkedidentc{Article}{NWlJ9ZL-10eMDV-2} -> the a)
...
;; (setf \nwlinkedidentc{*grammar*}{NWlJ9ZL-10eMDV-4} *bigger-grammar*)
\nwidentuses{\\{{\nwixident{*grammar*}}{*grammar*}}\\{{\nwixident{Adj}}{Adj}}\\{{\nwixident{Adj*}}{Adj*}}\\{{\nwixident{Article}}{Article}}\\{{\nwixident{Noun}}{Noun}}\\{{\nwixident{noun-phrase}}{noun-phrase}}\\{{\nwixident{PP}}{PP}}\\{{\nwixident{PP*}}{PP*}}\\{{\nwixident{Prep}}{Prep}}\\{{\nwixident{sentence}}{sentence}}\\{{\nwixident{Verb}}{Verb}}\\{{\nwixident{verb-phrase}}{verb-phrase}}}\nwindexuse{\nwixident{*grammar*}}{*grammar*}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Adj}}{Adj}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Adj*}}{Adj*}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Article}}{Article}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Noun}}{Noun}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{noun-phrase}}{noun-phrase}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{PP}}{PP}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{PP*}}{PP*}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Prep}}{Prep}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{Verb}}{Verb}{NWlJ9ZL-10eMDV-8}\nwindexuse{\nwixident{verb-phrase}}{verb-phrase}{NWlJ9ZL-10eMDV-8}\nwendcode{}\nwbegindocs{103}\nwdocspar

\section{Using the Same Data for Several Programs}

\nwenddocs{}\nwbegincode{104}\sublabel{NWlJ9ZL-10eMDV-9}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-9}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-8}{NWlJ9ZL-10eMDV-A}\nwenddeflinemarkup
(defun \nwlinkedidentc{generate-tree}{NWlJ9ZL-10eMDV-9} (phrase)\nwindexdefn{\nwixident{generate-tree}}{generate-tree}{NWlJ9ZL-10eMDV-9}
  "Generate a random \nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} or phrase,
  ...
  (if \LA{}phrase is a list~{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}\RA{}
    ...
    (\nwlinkedidentc{if-let}{NWlJ9ZL-33cvLf-1} (choices (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} phrase))
        (cons phrase
              (\nwlinkedidentc{generate-tree}{NWlJ9ZL-10eMDV-9} (\nwlinkedidentc{random-elt}{NWlJ9ZL-2bmzlG-1} (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} phrase))))
      (list phrase))))
\nwidentdefs{\\{{\nwixident{generate-tree}}{generate-tree}}}\nwidentuses{\\{{\nwixident{if-let}}{if-let}}\\{{\nwixident{random-elt}}{random-elt}}\\{{\nwixident{rewrites}}{rewrites}}\\{{\nwixident{sentence}}{sentence}}}\nwindexuse{\nwixident{if-let}}{if-let}{NWlJ9ZL-10eMDV-9}\nwindexuse{\nwixident{random-elt}}{random-elt}{NWlJ9ZL-10eMDV-9}\nwindexuse{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-10eMDV-9}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-9}\nwendcode{}\nwbegindocs{105}\nwdocspar

\nwenddocs{}\nwbegincode{106}\sublabel{NWlJ9ZL-10eMDV-A}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-A}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-9}{NWlJ9ZL-10eMDV-B}\nwenddeflinemarkup
(defun \nwlinkedidentc{generate-all}{NWlJ9ZL-10eMDV-A} (phrase)\nwindexdefn{\nwixident{generate-all}}{generate-all}{NWlJ9ZL-10eMDV-A}
  (cond ((null phrase) (list nil))
        (\LA{}phrase is a list~{\nwtagstyle{}\subpageref{NWlJ9ZL-2FJjMW-1}}\RA{}
         (\nwlinkedidentc{combine-all}{NWlJ9ZL-10eMDV-A} (\nwlinkedidentc{generate-all}{NWlJ9ZL-10eMDV-A} (first phrase))
                      (\nwlinkedidentc{generate-all}{NWlJ9ZL-10eMDV-A} (rest phrase))))
        (t (\nwlinkedidentc{if-let}{NWlJ9ZL-33cvLf-1} (choices (\nwlinkedidentc{rewrites}{NWlJ9ZL-10eMDV-5} phrase))
               (\nwlinkedidentc{mappend}{NWlJ9ZL-4BOcTg-1} #'\nwlinkedidentc{generate-all}{NWlJ9ZL-10eMDV-A} choices)
             (list (list phrase))))))

(defun \nwlinkedidentc{combine-all}{NWlJ9ZL-10eMDV-A} (xs ys)\nwindexdefn{\nwixident{combine-all}}{combine-all}{NWlJ9ZL-10eMDV-A}
  "Return a list of lists formed by appending a y to an x."
  (\nwlinkedidentc{cross-product}{NWlJ9ZL-10eMDV-C} #'append xs ys))
\nwidentdefs{\\{{\nwixident{combine-all}}{combine-all}}\\{{\nwixident{generate-all}}{generate-all}}}\nwidentuses{\\{{\nwixident{cross-product}}{cross-product}}\\{{\nwixident{if-let}}{if-let}}\\{{\nwixident{mappend}}{mappend}}\\{{\nwixident{rewrites}}{rewrites}}}\nwindexuse{\nwixident{cross-product}}{cross-product}{NWlJ9ZL-10eMDV-A}\nwindexuse{\nwixident{if-let}}{if-let}{NWlJ9ZL-10eMDV-A}\nwindexuse{\nwixident{mappend}}{mappend}{NWlJ9ZL-10eMDV-A}\nwindexuse{\nwixident{rewrites}}{rewrites}{NWlJ9ZL-10eMDV-A}\nwendcode{}\nwbegindocs{107}\nwdocspar

\section{Exercises}

\subsection{Exercise 2.3}

\nwenddocs{}\nwbegincode{108}\sublabel{NWlJ9ZL-10eMDV-B}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-B}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-A}{NWlJ9ZL-10eMDV-C}\nwenddeflinemarkup
(defparameter *grammática-simple*
  '((\nwlinkedidentc{sentence}{NWlJ9ZL-10eMDV-2} -> (frase-sustantiva frase-verbal))
...
\nwidentuses{\\{{\nwixident{sentence}}{sentence}}}\nwindexuse{\nwixident{sentence}}{sentence}{NWlJ9ZL-10eMDV-B}\nwendcode{}\nwbegindocs{109}\nwdocspar

\subsection{Exercise 2.4}

\nwenddocs{}\nwbegincode{110}\sublabel{NWlJ9ZL-10eMDV-C}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-C}}}\moddef{src/simple.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-10eMDV-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlJ9ZL-10eMDV-B}{\relax}\nwenddeflinemarkup
(defun \nwlinkedidentc{cross-product}{NWlJ9ZL-10eMDV-C} (func xlist ylist)\nwindexdefn{\nwixident{cross-product}}{cross-product}{NWlJ9ZL-10eMDV-C}
  "Return a list of all (func x y) values."
  (\nwlinkedidentc{mappend}{NWlJ9ZL-4BOcTg-1} #'(lambda (y)
               (mapcar #'(lambda (x) (funcall func x y))
                       xlist))
           ylist))
;; (setf (fdefinition 'zip-with) #'\nwlinkedidentc{cross-product}{NWlJ9ZL-10eMDV-C})

(define-test test-cross-product
  (assert-equal '(11 12 13
                  21 22 23
                  31 32 33)
                (\nwlinkedidentc{cross-product}{NWlJ9ZL-10eMDV-C} #'+ '(1 2 3) '(10 20 30))))
\nwidentdefs{\\{{\nwixident{cross-product}}{cross-product}}}\nwidentuses{\\{{\nwixident{mappend}}{mappend}}}\nwindexuse{\nwixident{mappend}}{mappend}{NWlJ9ZL-10eMDV-C}\nwendcode{}\nwbegindocs{111}\nwdocspar

\chapter{Overview of Lisp}

\nwenddocs{}\nwbegincode{112}\sublabel{NWlJ9ZL-3sUrxR-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3sUrxR-1}}}\moddef{find-all~{\nwtagstyle{}\subpageref{NWlJ9ZL-3sUrxR-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-wDl5T-1}}\nwenddeflinemarkup
...
\nwixlogsorted{c}{{Exercise 1.4}{NWlJ9ZL-19iRAp-1}{\nwixu{NWlJ9ZL-3M2WD4-1}\nwixd{NWlJ9ZL-19iRAp-1}}}%
\nwixlogsorted{c}{{Exercise 1.4 tests}{NWlJ9ZL-1GdKag-1}{\nwixu{NWlJ9ZL-19iRAp-1}\nwixd{NWlJ9ZL-1GdKag-1}}}%
\nwixlogsorted{c}{{Exercise 1.5}{NWlJ9ZL-3hXPUh-1}{\nwixu{NWlJ9ZL-3M2WD4-1}\nwixd{NWlJ9ZL-3hXPUh-1}}}%
\nwixlogsorted{c}{{Exercise 1.5 tests}{NWlJ9ZL-1GdGQe-1}{\nwixu{NWlJ9ZL-3hXPUh-1}\nwixd{NWlJ9ZL-1GdGQe-1}}}%
...
\nwixlogsorted{c}{{generate a phrase}{NWlJ9ZL-288w6M-1}{\nwixd{NWlJ9ZL-288w6M-1}\nwixu{NWlJ9ZL-10eMDV-6}\nwixu{NWlJ9ZL-10eMDV-7}}}%
...
\nwixlogsorted{c}{{if exp is nil there are if-null atoms}{NWlJ9ZL-3CRXLe-1}{\nwixu{NWlJ9ZL-2b8599-1}\nwixd{NWlJ9ZL-3CRXLe-1}}}%
\nwixlogsorted{c}{{if item is equal to tree, there is one occurrence}{NWlJ9ZL-1L8ovk-1}{\nwixu{NWlJ9ZL-19iRAp-1}\nwixd{NWlJ9ZL-1L8ovk-1}}}%
...
\nwixlogsorted{c}{{if tree is an atom, there are no occurrences}{NWlJ9ZL-4atmh5-1}{\nwixu{NWlJ9ZL-19iRAp-1}\nwixd{NWlJ9ZL-4atmh5-1}}}%
\nwixlogsorted{c}{{if-let}{NWlJ9ZL-33cvLf-1}{\nwixd{NWlJ9ZL-33cvLf-1}\nwixu{NWlJ9ZL-10eMDV-6}}}%
...
\nwixlogsorted{c}{{Morton Downey, Jr.}{NWlJ9ZL-12cyya-1}{\nwixu{NWlJ9ZL-29KvuZ-1}\nwixd{NWlJ9ZL-12cyya-1}}}%
\nwixlogsorted{c}{{multiply elements of the vectors pairwise and sum the results}{NWlJ9ZL-jnnLg-1}{\nwixu{NWlJ9ZL-3hXPUh-1}\nwixd{NWlJ9ZL-jnnLg-1}}}%
\nwixlogsorted{c}{{non-terminal-p}{NWlJ9ZL-WAQYi-1}{\nwixd{NWlJ9ZL-WAQYi-1}\nwixu{NWlJ9ZL-10eMDV-7}}}%
\nwixlogsorted{c}{{Nursery School Example}{NWlJ9ZL-4Zg5N4-1}{\nwixu{NWlJ9ZL-wDl5T-1}\nwixd{NWlJ9ZL-4Zg5N4-1}}}%
\nwixlogsorted{c}{{one-of}{NWlJ9ZL-3GVt2q-1}{\nwixu{NWlJ9ZL-10eMDV-2}\nwixd{NWlJ9ZL-3GVt2q-1}}}%
...
\nwixlogsorted{c}{{otherwise, add the occurrence within first the first and rest of tree}{NWlJ9ZL-4TNpRz-1}{\nwixu{NWlJ9ZL-19iRAp-1}\nwixd{NWlJ9ZL-4TNpRz-1}}}%
...
\nwixlogsorted{c}{{phrase is a list}{NWlJ9ZL-2FJjMW-1}{\nwixd{NWlJ9ZL-2FJjMW-1}\nwixu{NWlJ9ZL-10eMDV-6}\nwixu{NWlJ9ZL-10eMDV-7}\nwixu{NWlJ9ZL-10eMDV-9}\nwixu{NWlJ9ZL-10eMDV-A}}}%
\nwixlogsorted{c}{{phrase is nonterminal}{NWlJ9ZL-2uqsv4-1}{\nwixd{NWlJ9ZL-2uqsv4-1}\nwixu{NWlJ9ZL-10eMDV-7}}}%
...
\nwixlogsorted{c}{{src/simple.lisp}{NWlJ9ZL-10eMDV-1}{\nwixd{NWlJ9ZL-10eMDV-1}\nwixd{NWlJ9ZL-10eMDV-2}\nwixd{NWlJ9ZL-10eMDV-3}\nwixd{NWlJ9ZL-10eMDV-4}\nwixd{NWlJ9ZL-10eMDV-5}\nwixd{NWlJ9ZL-10eMDV-6}\nwixd{NWlJ9ZL-10eMDV-7}\nwixd{NWlJ9ZL-10eMDV-8}\nwixd{NWlJ9ZL-10eMDV-9}\nwixd{NWlJ9ZL-10eMDV-A}\nwixd{NWlJ9ZL-10eMDV-B}\nwixd{NWlJ9ZL-10eMDV-C}}}%
